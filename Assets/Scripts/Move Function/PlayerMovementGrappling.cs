...
public class PlayerMovementGrappling : MonoBehaviour
{
    ...
    [SerializeField] private Transform cameraPos;       // 카메라 트랜스폼
    ...
    private void MyInput()
    {
        ...
        // 카메라 기준 방향 벡터 계산
        Vector3 forward = new Vector3(cameraPos.forward.x, 0, cameraPos.forward.z).normalized;
        Vector3 right = new Vector3(cameraPos.right.x, 0, cameraPos.right.z).normalized;
